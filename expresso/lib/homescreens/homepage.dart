              ...
              child: ListView(
                ...
                Padding(
                  ...
                  child: ListTile(
                    ...
                    title: const Text('CONSUMER',style: TextStyle(fontSize: 20,fontWeight: FontWeight.w700,color: kButtonTextColor),),
                    onTap: () {
                ...
                Padding(
                  ...
                  child: ListTile(
                    ...
                    title: const Text('SHIPPER',style: TextStyle(fontSize: 20,fontWeight: FontWeight.w700,color: kButtonTextColor)),
                    onTap: () {
                      Navigator.pop(context);
                    },
                  ),
                ...
                Padding(
                  ...
                  child: ListTile(
                    ...
                    title: const Text('ABOUT',style: TextStyle(fontSize: 20,fontWeight: FontWeight.w700,color: kButtonTextColor)),
                    onTap: () {
                      Navigator.pop(context);
                    },
                  ),
                ...
                Padding(
                  ...
                  child: ListTile(
                    ...
                    title: const Text('CONTACT US',style: TextStyle(fontSize: 20,fontWeight: FontWeight.w700,color: kButtonTextColor)),
                    onTap: () {
                      Navigator.pop(context);
                    },
                  ),
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      padding: EdgeInsets.only(
                          left: screenWidth * 0.02, top: screenHeight * 0.009),
                      child: const Text(
                        "ORDER DETAILS",
                        style: TextStyle(
                            fontSize: 23,
