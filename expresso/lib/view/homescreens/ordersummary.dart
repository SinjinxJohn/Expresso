                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                padding: EdgeInsets.only(
                                    left: 174, top: screenHeight * 0.03),
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                padding: EdgeInsets.only(
                                    left: 150, top: screenHeight * 0.01),
                                child: const Text("\$ 320",
                                    style: TextStyle(
                                        color: kPriceColor,
                                        fontSize: 15,
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                padding: EdgeInsets.only(
                                    left: 155, top: screenHeight * 0.01),
                                child: const Text("\$ 320",
                                    style: TextStyle(
                                        fontSize: 15,
                                        fontWeight: FontWeight.w700)),
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                padding: EdgeInsets.only(
                                    left: 119, top: screenHeight * 0.03),
                                child: const Text("\$ 320",
                                    style: TextStyle(
                                        fontSize: 15,
                                        fontWeight: FontWeight.w700)),
